...
/**
 * Descripcion: La clase DefaultErrorResponseBean, usada para enviar la respuesta en caso de error durante la ejecucion del servicio.
 * 
...
public class DefaultErrorList implements Serializable {
	 ...
	 */
	public final void add(final DefaultError errorBean) {
